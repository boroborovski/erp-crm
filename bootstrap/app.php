...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withSchedule(function (Schedule $schedule): void {
        $schedule->job(PollMailboxJob::class)->everyFiveMinutes();
        $schedule->command(MarkOverdueInvoices::class)->dailyAt('01:00');
        $schedule->command(NotifyLowStock::class)->dailyAt('08:00');
