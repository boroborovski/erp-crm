    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('name')
                ->label(__('resources.exporters.columns.company_name')),
            ...
            ExportColumn::make('people_count')
                ->label(__('resources.exporters.columns.number_of_people'))
                ->state(fn (Company $company): int => $company->people()->count()),
            ExportColumn::make('opportunities_count')
                ->label(__('resources.exporters.columns.number_of_opportunities'))
