...
final class CreateTeam extends RegisterTenant
{
    ...
    {
        return __('resources.pages.create_team.label');
    }

    #[Override]
    public function getHeading(): string
    {
        return __('resources.pages.create_team.heading');
    }

    #[Override]
    public function getSubheading(): string
    {
        return __('resources.pages.create_team.subheading');
    }
        ...
        return $schema
            ->components([
                ...
                TextInput::make('slug')
                    ...
                    ->prefix("{$appHost}/")
                    ->helperText(__('resources.pages.create_team.slug_helper'))
                    ->live(onBlur: true)
