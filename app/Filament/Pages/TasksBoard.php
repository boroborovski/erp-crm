...
final class TasksBoard extends BoardPage
{
    ...
    public function board(Board $board): Board
    {
        ...
        return $board
            ...
            ->columnActions([
                CreateAction::make()
                    ->label(__('resources.actions.add_task'))
    ...
    private function formatDueDateBadge(?string $state): string
    {
        ...
        return match (true) {
            $date->isPast() => $date->format('M j, Y').' ('.__('resources.dates.overdue').')',
            $date->isToday() => __('resources.dates.due_today'),
            $date->isTomorrow() => __('resources.dates.due_tomorrow'),
