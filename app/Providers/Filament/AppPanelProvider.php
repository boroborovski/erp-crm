...
final class AppPanelProvider extends PanelProvider
{
    ...
    public function boot(): void
    {
        ...
        DeleteAction::configureUsing(fn (DeleteAction $action): DeleteAction => $action->label(__('resources.actions.delete_record')));
    ...
    public function panel(Panel $panel): Panel
    {
        ...
        $panel
            ...
            ->brandName('Relaticle')
            ->brandLogo(fn (): View|Factory => view('filament.app.logo-empty'))
            ...
            ->userMenuItems([
                Action::make('profile')
                    ->label(__('resources.panel.profile'))
            ...
            ->navigationGroups([
                NavigationGroup::make()
                    ->label(__('resources.navigation.groups.workspace')),
                NavigationGroup::make()
                    ->label(__('resources.navigation.groups.erp')),
            ])
            ->middleware([
        ...
        if (Features::hasApiFeatures()) {
            $panel->userMenuItems([
                Action::make('api_tokens')
                    ->label(__('resources.panel.api_tokens'))
                    ->icon('heroicon-o-key')
                    ->url(fn (): string => $this->shouldRegisterMenuItem()
        ...
        $panel
            ...
            ->tenantMenuItems([
                Action::make('import_history')
                    ->label(__('resources.panel.import_history'))
