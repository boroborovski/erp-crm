@props(['title', 'description' => 'The Complete CRM & ERP Platform for modern businesses', 'ogTitle' => null, 'ogDescription' => null, 'ogImage' => null])
...
<head>
    ...
    <title>{{ $title ?? config('app.name', 'The Complete CRM & ERP Platform') }}</title>
