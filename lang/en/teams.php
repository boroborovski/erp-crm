...
return [
    'form' => [
        ...
        'erp_enabled' => [
            'label' => 'Enable ERP Module',
            'helper_text' => 'When enabled, the ERP section (Products, Quotes, Invoices, Projects) will be visible to all team members.',
        ],
    ],
    ...
    'sections' => [
        ...
        'erp_settings' => [
            'title' => 'ERP Module',
            'description' => 'Enable or disable the ERP module for this workspace.',
        ],
        'delete_team' => [
            'title' => 'Delete Team',
